...
{
    /// <summary>
    ///     Obtain the name of the property from the item, which is currently displayed by the pie chart.
    /// </summary>
    ...
    public class NameConverter : IValueConverter
    {
            ...
            object parameter, CultureInfo culture)
        {
            ...
            var itemValue = filterPropDesc[legend.PropertyName].GetValue(item);
            return itemValue;
        }
